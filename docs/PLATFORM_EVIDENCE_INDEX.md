...
- Category: `deployment`
- Status: `PASS`
- Proof: Real GitHub Actions run page shows the service CI workflow that published the latest tag metadata used by deployment-poc.
...
- Category: `deployment`
- Status: `PASS`
- Proof: Real GitHub file page shows the latest_tags entry that deployment-poc resolved for this deployment.
...
- Category: `deployment`
- Status: `PASS`
- Proof: Fresh Jira ticket creation, progress comments, and final completed status were verified via Jira REST API.
...
- Category: `gitops`
- Status: `PASS`
- Proof: ArgoCD login or application view is visible
